...
if __name__ == "__main__":
    ...
    # regression list
    fieldnames = ['accuracy', 'precision', 'recall', 'objective', 'boosting_type', 'learning_rate', 'max_depth', 'num_leaves',
                  'min_child_weight', 'max_bin', 'subsample', 'colsample_bytree', 'reg_lambda', 'reg_alpha']
    objective_list = ['poisson']
    booster_list = ['dart']
    ...
    learning_rate_list = [0.13, 0.2, 0.3]  # 3
    ...
    for objective in objective_list:
        for booster in booster_list:
            ...
            filePath = "LightGBMRegressor_" + objective + "_" + booster + "_result.csv"
